...
lib.ssMetadata = [
		{name:"RECOVER_Untitled_1_atlas_", frames: [[1332,0,236,225],[0,0,1028,177],[1570,0,130,106],[1030,0,300,225]]}
];
...
(lib.box = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#998675").ss(1,1,1).p("ALCAAQAAEljPDOQjPDPkkAAQkjAAjPjPQjPjOAAklQAAkkDPjOQDPjPEjAAQEkAADPDPQDPDOAAEkg");
	this.shape.setTransform(0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.box, new cjs.Rectangle(-71,-71,143.1,143.1), null);
...
(lib.star = function(mode,startPosition,loop) {
	...
	this.starText.setTransform(0.3,-43.4);

	this.timeline.addTween(cjs.Tween.get(this.starText).wait(1));

	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AovG2IAAtrIRfAAIAANrg");
	...
	this.instance.parent = this;
	this.instance.setTransform(-89,-87,0.771,0.771);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.star, new cjs.Rectangle(-89,-87,181.9,173.4), null);
	...
	this.frame_0 = function() {
		...
		function sabject(Coise){
			if(Coise==1){
				...
				quition[2]=["t","קוף ממשפחת המרמטיים - טמרין רעמתי מוזהב ראש",false,false,true];
				/*quition[6]=["t","יחמור פרסי",false,false,true];
				quition[7]=["t","היפופוטם",false,false,true];
				quition[3]=["t","למור קטה",false,false,true];
				quition[4]=["t","חתול",true,false,true];*/
				quition[3]=["p",lib.animel1,true,false,true];
